...
高质量离线流程不再使用 `sky_bake_panorama()`。它先通过六个 90° 相机方向直接渲染 2048×2048 立方体面，再用双线性投影转换为 Quest Sky 使用的 7096×3548、2:1 经纬度 PNG。
...
夜景包含 Sky3D 使用的银河素材，因此发布项目必须保留 `addons/quest_sky/assets/sky/SKY3D_ATTRIBUTION.md` 中的署名。
